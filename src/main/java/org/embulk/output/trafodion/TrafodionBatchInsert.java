...
public class TrafodionBatchInsert
        extends StandardBatchInsert
{
    public TrafodionBatchInsert(TrafodionOutputConnector connector, Optional<MergeConfig> mergeConfig) throws IOException, SQLException
    {
